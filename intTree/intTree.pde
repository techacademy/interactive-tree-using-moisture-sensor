...
Serial myPort; //Create object 

String val; //data from serial port (string int float etc)
int x;
...
String portName = Serial.list()[0]; // match port 
myPort = new Serial(this, portName , 9600); // setup port
  ...
  levels = 7;//int(random(7,9));  //arbitrary range here, it's the range I found to make most realistic looking trees
